namespace BloodWorkDocument_API.Services
{
    public static class Dictionaries
    {
        /*public static readonly Dictionary<string, string> NHANESReference = new()
        {
                ...
                { "Anti-phospholipase A2 receptor (PLA2R) antibodies,", "Negative: <14 RU/mL" },
                { "serum", "Borderline: 14 – <20 RU/mL" },
                { "[ELISA]", "Positive: ≥20 RU/mL" },
                { "Anti-RNP antibodies", "<20 CU" },
                { "[by chemiluminescence method]", "" },
                { "Anti-RNP antibodies", "<1.0 AI" },
                { "[by multiplex flow immunoassay]", "" },
                { "Anti-Scl-70 antibodies (topoisomerase 1 antibodies), IgG,", "Negative: <1.0 U" },
                { "serum", "[Positive: ≥1.0 U]" },
                { "Anti–smooth muscle antibodies", "≤1:80" },
                { "Anti-SSA/Ro & anti-SSB antibodies", "<20 CU" },
                { "[by chemiluminescence method]", "" },
                { "Anti-SSA/Ro & anti-SSB antibodies", "<1.0 AI" },
                { "[by multiplex flow immunoassay]", "" },
